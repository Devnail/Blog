<?php /*a:1:{s:56:"D:\phpEnv\www\www.ytv.com\app\admin\view\roles\edit.html";i:1617160933;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="menu[<?php echo htmlentities($value['mid']); ?>]" lay-skin="primary" title="<?php echo htmlentities($value['title']); ?>" <?php echo isset($role['rights'])&&
            ...
            <input type="checkbox" name="menu[<?php echo htmlentities($cvalue['mid']); ?>]" lay-skin="primary" title="<?php echo htmlentities($cvalue['title']); ?>" <?php echo isset($role['rights'])&&
