<?php /*a:1:{s:58:"D:\phpEnv\www\www.ytv.com\app\admin\view\article\edit.html";i:1618066488;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form">
    <input type="hidden" name="id" value="<?php echo htmlentities($articleData['id']); ?>">
    <div class="layui-form-item">
        <label class="layui-form-label">标题</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="title" value="<?php echo htmlentities($articleData['title']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="cate_id">
                ...
                <option value="<?php echo htmlentities($cv['id']); ?>" <?php if($cv['id'] == $articleData['cate_id']): ?>selected="selected" <?php endif; ?>><?php echo htmlentities($cv['name']); ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="keywords" value="<?php echo htmlentities($articleData['keywords']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">描述</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="desc" value="<?php echo htmlentities($articleData['desc']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <img src="<?php echo htmlentities($articleData['img']); ?>" id="preview_img" height="30px">
            <input type="hidden" name="img" value="<?php echo htmlentities($articleData['img']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
            <input value="<?php echo $articleData['content']; ?>" name="content" type="hidden" >
            <textarea id="edit">
